...
$(function () {
    ...
    layui.use(['element', 'form', 'table','upload'], function () {
        ...
        for (var i = 0; i < Dictionary.size() ; i++) {
            ...
            $.ajax({
                url: "/Admin/CRM_SourceInfo/GetDictionaryData?itemTypeID=" + _this.id,
                async: false,
                        ...
                        for(var i=0;i<data.length;i++){
                            ...
                            if (imgExt.indexOf(ext) >= 0) {
                                var tr = $(['<tr id=' + _self.ID + '>',
                                  ...
                                  '<td style="width:40%!important;"><a href=' + _self.FILE_PATH + ' download=' + _self.ORIGINAL_NAME + '><img src=' + _self.FILE_PATH + '></a></td>',
